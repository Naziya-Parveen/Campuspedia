...
<div id="slider">
    ...
    <div id="content">
      ...
      out.print("<tr>");
      out.print("<td>Day</td>");
      out.print("<td>Subject code</td>");
      out.print("<td>Class</td>");
      out.print("<td>Faculty name</td>");
 ...
 Connection con = null;
      try{
         ...
         String sql = "select day,subject_code,class,faculty_name,start_time,end_time from timetable where day=? and subject_code=?";
         ...
         while(rs.next())
         {
              ...
              out.print("<td>"+rs.getString("subject_code")+"</td>");
              out.print("<td>"+rs.getString("class")+"</td>");
              out.print("<td>"+rs.getString("faculty_name")+"</td>");
